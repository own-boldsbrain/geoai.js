...
try {
  const reactPackagePath = path.resolve('build/dist/@geobase-js/geoai-react.js');
...
try {
  ...
  if (packageJson.exports && packageJson.exports['.'] && packageJson.exports['./react']) {
  ...
  if (packageJson.peerDependenciesMeta && packageJson.peerDependenciesMeta.react?.optional) {
...
console.log('   React: import { useGeoAIWorker } from "@geobase-js/geoai/react"');