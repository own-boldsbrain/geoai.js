...
<Callout type="info" emoji="ℹ️">
  This guide uses the latest version of @geobase-js/geoai for optimal
...
git subtree add --prefix=examples/01-geobase-geoai.js-quickstart https://github.com/decision-labs/geobase-ai.js main --squash
```
