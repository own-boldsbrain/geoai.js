            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="col-span-1 md:col-span-2">
                ...
                <p className="text-gray-300 text-base max-w-md">
                  Open-source GeoAI toolkit for JavaScript developers. Run Geospatial AI models directly in your browser or edge devices without any backend infrastructure.
                </p>
              </div>
              <div>
