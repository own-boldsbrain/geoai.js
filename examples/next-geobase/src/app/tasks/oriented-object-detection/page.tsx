...
export default function OrientedObjectDetection() {
    ...
    workerRef.current.onmessage = e => {
      ...
      switch (type) {
        ...
        case "inference_complete":
          ...
          setDetecting(false);
          setDetectionResult("Oriented Object detection complete!");
          break;
        case "error":
          setDetecting(false);
          setInitializing(false);
      ...
      <aside className="w-96 bg-white border-r border-gray-200 h-full flex flex-col overflow-hidden">
        <div className="p-6 flex flex-col gap-6 text-black shadow-lg overflow-y-auto">
          <div className="space-y-2">
            <h2 className="text-2xl font-bold text-gray-800">Oriented Object Detection</h2>
            <p className="text-sm text-gray-600">
              Draw a polygon on the map and run Oriented Object detection within the
              selected area.
            </p>
          </div>
