...
const GEOBASE_CONFIG = {
  ...
  center: [-99.0983079371952, 46.60892272965549],
  zoom: 17,
};
      ...
      <aside className="w-96 bg-white border-r border-gray-200 h-full flex flex-col overflow-hidden">
        <div className="p-6 flex flex-col gap-6 text-black shadow-lg overflow-y-auto">
          <div className="space-y-2">
            <h2 className="text-2xl font-bold text-gray-800">WetLand Segmentation (GeoAI Model)</h2>
            <p className="text-sm text-gray-600">
              Draw a polygon on the map and run WetLand Segmentation within the
              selected area.
            </p>
          </div>
